...
Build this and run. A window should appear, and be closed right away because the program exits. We need to wait for some input, for example until the user hits the Escape key :
